...
import { loadWorkflowState } from "../lib/workflowStore";
      ...
      <section>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <button
            ...
            className="flex items-start gap-4 p-5 bg-card border border-border rounded-xl shadow-sm hover:bg-secondary/40 transition-colors text-left"
          >
